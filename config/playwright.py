...
class Playwright:
    ...
    BROWSER = os.getenv('BROWSER') if os.getenv('BROWSER') is not None else 'chrome' #Она отвечает за то, в каком браузере будут выполняться автотесты. По умолчанию там указан Google Chrome.
